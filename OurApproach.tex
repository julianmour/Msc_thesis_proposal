...
%        \Dana{not clear, can you define it mathematically?}
        ...
        We translate the problem of finding sensitive pixels to finding sensitive layers by averaging all pixels' gradients in each layer. Accordingly, we define the cutting vector 
